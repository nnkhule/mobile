...
class MusicalScreen extends StatefulWidget {
  const MusicalScreen({super.key});

  @override
  State<MusicalScreen> createState() => _MusicalScreenState();
}

class _MusicalScreenState extends State<MusicalScreen> {
  String selectedGenre = "Мюзикл";
  ...
  Widget build(BuildContext context) {
    final filteredList = movieList.where((m) => m.category == "Мюзикл").toList();
